...
// Filtros por sesión
$filterKey = 'hp_filters';

if (!$codigoCliente || !preg_match('/^[A-Za-z0-9_-]+$/', $codigoCliente)) {
    http_response_code(403);
    logSecurityEvent('access_denied', ['reason' => 'missing_or_invalid_client_code', 'page' => 'hp']);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!csrfValidate()) {
        csrfRefresh();
        logSecurityEvent('csrf_validation_failed', ['page' => 'hp', 'uri' => $_SERVER['REQUEST_URI']]);
...
<head>
    ...
    <title>One Page — H&amp;P · Breinit DCA</title>
    ...
    <div class="layout">
        <aside class="sidebar" id="sidebar">
            ...
            <nav>
                ...
                <a href="hp.php" class="activo"><span class="material-symbols-outlined">brush</span> H&amp;P</a>
